...
public class SceneGraph extends JPanel {
    ...
    private void createWorld() {
        ...
        rotatingPolygon1.setScale(0.01,0.01).setColor(Color.BLACK);
        ...
        rotatingPolygon2.setScale(0.012,0.012).setColor(Color.BLACK);
        ...
        rotatingPolygon3.setScale(0.007,0.007).setColor(Color.BLACK);
